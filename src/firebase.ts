...
// Support both .env environment variables (for custom user deployments) and the default applet config
...
// Structured Error Handling for Security Auditing and Diagnostics
